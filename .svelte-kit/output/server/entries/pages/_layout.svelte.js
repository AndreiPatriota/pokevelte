import "clsx";
import { V as fallback, W as bind_props, Q as push, X as ensure_array_like, Y as attr, T as pop, Z as sanitize_props, _ as store_get, $ as add_styles, a0 as merge_styles, a1 as clsx, a2 as spread_props, a3 as slot, a4 as escape_html, a5 as unsubscribe_stores, a6 as rest_props, a7 as spread_attributes, S as setContext } from "../../chunks/index.js";
import { o as onDestroy } from "../../chunks/index-server.js";
import { c as cn, t as toastState, u as useEffect } from "../../chunks/Toaster.svelte_svelte_type_style_lang.js";
import { g as get, w as writable, d as derived } from "../../chunks/index3.js";
...
function NavBar($$payload, $$props) {
  let { estaLogado } = $$props;
  $$payload.out += `<nav class="shadow-md bg-secondary svelte-18a1vqq"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex justify-between h-16 items-center"><div class="flex-shrink-0"><a href="/" class="text-2xl font-bold text-blue-600">PokeSvelte</a></div> <div class="hidden md:flex space-x-8"><a href="/pokemons" class="text-gray-600 hover:text-blue-600">Pokemons</a> <a href="/sobre" class="text-gray-600 hover:text-blue-600">Sobre</a> `;
  if (estaLogado) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<a href="/api/auth/logout" class="text-gray-600 hover:text-blue-600">Sair</a>`;
  } else {
    $$payload.out += "<!--[!-->";
    $$payload.out += `<a href="/login" class="text-gray-600 hover:text-blue-600">Entrar</a>`;
  }
  $$payload.out += `<!--]--></div> <div class="md:hidden"><button class="text-gray-600 hover:text-blue-600 focus:outline-none">`;
  {
    $$payload.out += "<!--[-->";
...
function _layout($$payload, $$props) {
  ...
  let ctx = { logado: data.logado };
  setContext("context", ctx);
  $$payload.out += `<div class="max-h-screen overflow-y-hidden font-geral">`;
  Sonner_1($$payload, {});
  $$payload.out += `<!----> `;
  NavBar($$payload, { estaLogado: ctx.logado });
  $$payload.out += `<!----> <main>`;
  children($$payload);
